...
- **Thresholds** — minimum score to include a result in the Slack notification.
...
Defines the daily check-in questions sent to Slack each morning. The answers are stored in daily notes and used by `generate_summary.py` for weekly analysis.
